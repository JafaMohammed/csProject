...
//       $sql = "INSERT INTO response (Status)
//       VALUES ('$Status')";
...
<body>
  ...
  <div class="container-fluid">
    ...
    <label for="code" style="text-align:center;"> STATUS</label>
    <!-- <input type="text" class="form-control" name="pay" aria-describedby="pay" value= -->
    <?php 
    ...
    ?> 
           ...
           <p>
        <a href="index.php" class="btn btn-warning" style="align-content: center;">Continue Browsing</a>
        
    </p>
          <!--  <p>
        
        <input type="submit" name="pay"class="btn btn-warning" style="align-content: center;"value="">
    </p> -->
        <!--    <p>
        <a href="index.php" class="btn btn-warning" style="align-content: center;">Continue Browsing</a>
